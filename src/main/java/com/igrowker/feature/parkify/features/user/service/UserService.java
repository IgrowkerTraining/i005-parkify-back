...
import com.igrowker.feature.parkify.features.user.dto.response.UserDetailsResponse; // ⬅️ Añade este import
...
public interface UserService {
    ...
    UserDetailsResponse getCurrentUserDetails(); // ⬅️ Añade esta línea
}
